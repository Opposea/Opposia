-- Update the calculate_compatibility_score function to handle "together" answers
...
BEGIN
  ...
  -- Count "together" matches (both answered together)
  SELECT COUNT(*)
  ...
  IF total_questions > 0 THEN
    ...
    -- Sometimes matches get partial points (50% of opposite value)
    -- Together matches get partial points (50% of opposite value)
    compatibility_score := ROUND(
      ((opposite_answers::DECIMAL * 1.0 + sometimes_matches::DECIMAL * 0.5 + together_matches::DECIMAL * 0.5) / total_questions::DECIMAL) * 70
    );
  END IF;
